...
//=================_|===========================================================
    string constant public name = "FoMoGo";
    string constant public symbol = "FoMoGo";
...
//==============================================================================
        ...
        returns (F3Ddatasets.EventReturns)
    {
        ...
        // community rewards
        if (!address(FundForwarder).call.value(_com)(bytes4(keccak256("deposit()"))))
        {
        ...
        if (_p3d > 0){
            ...
            FundForwarder.deposit.value(_p3d)();
        }
